...
* `r round(output.psm$data_vanwestendorp[260, "ecdf_not_cheap"], digits = 2) * 100`% of respondents think that this price is *not* cheap - this is the inverse of edfc_cheap (so both values always add up to 100%)
* `r round(output.psm$data_vanwestendorp[260, "ecdf_not_expensive"], digits = 2) * 100`% of respondents think that this price is *not* expensive - this is the inverse of edfc_expensive (so both values always add up to 100%)
